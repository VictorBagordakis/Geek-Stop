<section id="casacos">
	...
	<div id = "todosCasacos" class="secaoProdutosSemFiltro">
		<div id="casacos" class="produtos">
			...
			<div class="produto" id= "casaco2">
                <?= $this->Html->image('casacos\casaco2.jpg', ['alt' => 'Casaco Xbox', 'class' => 'imagensProdutos']); ?>
				<div id="infoProduto">
					<span class="nomeProduto">Casaco Xbox</span>
					<span class="precoProduto">229,90</span>
					<button><span class="material-icons iconeAdicionarCarrinho">add_shopping_cart</span></button>
				</div>
			</div>
			<div class="produto" id= "casaco3">
