			...
			<div class="produtos" >
				...
				echo '<div class="produto" id = "camisetaMasculina' . $cont.'">';
					...
					echo '<div id="infoProduto">';
						echo '<span class="nomeProduto">' . $produto->nome . '</span>';
						echo '<span class="precoProduto">' . number_format($produto->preco, 2, ',', '') . '</span>';
						echo '<a href="' . $this->Url->build(['controller'=>'Users', 'action'=>'carrinhoDeCompras']) . '" class="button"><span class="material-icons iconeAdicionarCarrinho">add_shopping_cart</span></a>';
					echo '</div>';
				echo '</div>';
				if($cont == 3):
					break;
